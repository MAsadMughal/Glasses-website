            ...
            <MultiCarousel className='mx-[5%] ' infinite={true} arrows={false} partialVisible={false} responsive={responsive} autoPlay={false} >
                {[glassescar4, glassescar3, glassescar2, glassescar1].map((item, ind) => {
                    return (<div className='bg-white p-[10px] flex flex-col justify-center align-middle'>
                        ...
                        {ind === 3 && <div className='flex flex-row flex-nowrap px-[5px] justify-center align-middle'>
                        ...
                        {ind !== 3 && <p className='truncate ms-[10px] text-xs lg:text-lg'>US $28.95</p>}
                    </div>
                    )
                })}
            </MultiCarousel>
