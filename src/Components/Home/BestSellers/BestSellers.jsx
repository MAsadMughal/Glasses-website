...
const BestSellers = () => {
    return (
        <div className='flex flex-col items-center mt-[10vh]'>
            ...
            <p className='text-md mt-3 font-sans w-[90%] md:w-[50%] text-center opacity-70'>Rich in style and well-crafted, zeelool optical has helped 1,000,000 families to see clearly,
            ...
            <div className='w-[90%] flex flex-row justify-center mt-10'><img src={bestbar} alt='bar' /></div>
        </div>
    )
}
